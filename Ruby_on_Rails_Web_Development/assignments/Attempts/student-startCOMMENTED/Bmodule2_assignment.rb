...
class LineAnalyzer
  ...
  #  highest_wf_words - array of words with the maximum number of occurrences
  #  (calculated)
...
class Solution
  ...
  #  analyze_file() - processes 'test.txt' intro an array of LineAnalyzers and
  #  stores them in analyzers.
