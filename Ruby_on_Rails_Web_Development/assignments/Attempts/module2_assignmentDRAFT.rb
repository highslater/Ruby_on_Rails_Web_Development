...
class LineAnalyzer
 ...
 class Solution
  ...
  def calculate_line_with_highest_frequency()
    ...
    # calculates highest count words across lines to be will, it,
    # really (FAILED - 3)
    #* calculate the maximum value for highest_wf_count contained by the
    # LineAnalyzer objects in analyzers array and stores this result in the
    # highest_count_across_lines attribute.
    #* identifies the LineAnalyzer objects in the analyzers array that have
    # highest_wf_count equal to highest_count_across_lines attribute value
    # determined previously and stores them in highest_count_words_across_lines.
  end
