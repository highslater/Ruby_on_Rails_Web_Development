class LineAnalyzer
  ...
  def calculate_word_frequency()
    words = @content.split(' ')
    @highest_wf_count = Hash.new(0) # a number
    @highest_wf_words = []
 ...
 class Solution
  ...
  attr_reader
  :analyzers,:highest_count_across_lines,
  ...
  def calculate_line_with_highest_frequency()
    ...
    @highest_count_across_lines << [analyser.highest_wf_count, analyser.highest_wf_words]
    end
