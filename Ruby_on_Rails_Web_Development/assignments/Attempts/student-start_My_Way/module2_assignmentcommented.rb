 ...
 class Solution
  ...
  def calculate_line_with_highest_frequency()
    ...
    @analyzers.each do |analyser|
      # p analyser.highest_wf_words
      @highest_count_words_across_lines << analyser.highest_wf_words
    end

    # puts
    # puts "2.) highest_count_words_across_lines: OK"
    ...
    # puts
    # puts "3.) highest_count_across_lines: OK"
    ...
    # puts
    # puts "4.)"
    # @highest_count_words_across_lines.map {|k, v| v == @highest_count_across_lines}
    # p @highest_count_words_across_lines
    # p @highest_count_words_across_lines[0].values
    # p @highest_count_words_across_lines[1].values
    # p @highest_count_words_across_lines[2].values
